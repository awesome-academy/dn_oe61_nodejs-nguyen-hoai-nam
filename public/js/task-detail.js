document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateUI = (task) => {
        ...
        if (task.subject) {
            ...
            document.getElementById('subject-name').textContent = tMsg('common.notAvailable');
            document.getElementById('subject-description').textContent = tMsg('noSubjectFound');
            document.getElementById('subject-duration').textContent = tMsg('common.notAvailable');
        }
    };
