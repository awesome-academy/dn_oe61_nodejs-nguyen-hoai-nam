...
import { CourseReminderService } from './course_reminder.service';
import { MailQueueModule } from 'src/helper/Queue/mail/mail_queue.module';
import { DailySummaryEmailService } from './daily_summary_email.service';

@Module({
  imports: [TypeOrmModule.forFeature([Course, UserCourse, CourseSubject, SupervisorCourse, User, UserSubject, UserTask, Task, SupervisorCourse]),MailQueueModule],
  controllers: [ReportingController],
  providers: [ReportingService,I18nUtils,PaginationService,GetCourse,CourseReminderService,DailySummaryEmailService,Logger]
})
